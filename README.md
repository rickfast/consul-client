...
Grab the latest binary (0.11.2) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/0.11.2/#consul-client-0.11.2.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:0.11.2'
}
```

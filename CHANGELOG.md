...
- KV client- No putValue\(\) method that  accepts token as a put option/query param [\#209](https://github.com/OrbitzWorldwide/consul-client/issues/209)

**Merged pull requests:**

- because of changes in consul 0.7.3 there is need to not use connection limit in case of long pooling [\#212](https://github.com/OrbitzWorldwide/consul-client/pull/212) ([DanielCharczynski](https://github.com/DanielCharczynski))

## [0.13.9](https://github.com/OrbitzWorldwide/consul-client/tree/0.13.9) (2017-01-20)
[Full Changelog](https://github.com/OrbitzWorldwide/consul-client/compare/0.13.8...0.13.9)

**Closed issues:**

- set up TLSSkipVerify during registrations [\#208](https://github.com/OrbitzWorldwide/consul-client/issues/208)
- TLSSkipVerify support from consul 0.7.2 [\#206](https://github.com/OrbitzWorldwide/consul-client/issues/206)

**Merged pull requests:**

- revving embedded consul [\#205](https://github.com/OrbitzWorldwide/consul-client/pull/205) ([rickfast](https://github.com/rickfast))

## [0.13.8](https://github.com/OrbitzWorldwide/consul-client/tree/0.13.8) (2016-12-21)
[Full Changelog](https://github.com/OrbitzWorldwide/consul-client/compare/0.13.7...0.13.8)

**Closed issues:**

- Key/Value Cache - issue with getKeyExtractorFunction\(\) [\#196](https://github.com/OrbitzWorldwide/consul-client/issues/196)
- NPE in KeyValueClient.getValuesAsString\(\) [\#194](https://github.com/OrbitzWorldwide/consul-client/issues/194)

**Merged pull requests:**

- Maintenance endpoint is a PUT, not GET [\#199](https://github.com/OrbitzWorldwide/consul-client/pull/199) ([jplock](https://github.com/jplock))
- Fix getKeyExtractorFunction\(\) for Key/Value Cache [\#198](https://github.com/OrbitzWorldwide/consul-client/pull/198) ([yfouquet-criteo](https://github.com/yfouquet-criteo))

## [0.13.7](https://github.com/OrbitzWorldwide/consul-client/tree/0.13.7) (2016-12-19)
[Full Changelog](https://github.com/OrbitzWorldwide/consul-client/compare/0.13.6...0.13.7)

**Closed issues:**

- vverefbkdtcncjvunvggegketlugcfgcfefcidtibecf [\#195](https://github.com/OrbitzWorldwide/consul-client/issues/195)

**Merged pull requests:**

- Fix maintenance route [\#197](https://github.com/OrbitzWorldwide/consul-client/pull/197) ([jplock](https://github.com/jplock))

## [0.13.6](https://github.com/OrbitzWorldwide/consul-client/tree/0.13.6) (2016-12-12)
[Full Changelog](https://github.com/OrbitzWorldwide/consul-client/compare/0.13.5...0.13.6)

**Closed issues:**

- Support for adding custom headers [\#192](https://github.com/OrbitzWorldwide/consul-client/issues/192)
- Add support for registering services in catalog [\#191](https://github.com/OrbitzWorldwide/consul-client/issues/191)
- Telemetry Deserialization Issue [\#190](https://github.com/OrbitzWorldwide/consul-client/issues/190)
- Blocking call for value - Example Code - Issue [\#188](https://github.com/OrbitzWorldwide/consul-client/issues/188)

**Merged pull requests:**

- Added proxy support [\#193](https://github.com/OrbitzWorldwide/consul-client/pull/193) ([harrol](https://github.com/harrol))

## [0.13.5](https://github.com/OrbitzWorldwide/consul-client/tree/0.13.5) (2016-12-08)
[Full Changelog](https://github.com/OrbitzWorldwide/consul-client/compare/0.13.4...0.13.5)

**Closed issues:**

- How to register my service with path? [\#189](https://github.com/OrbitzWorldwide/consul-client/issues/189)
- Add CatalogOptions to KeyValueClient, or add Datacenter to QueryOptions [\#187](https://github.com/OrbitzWorldwide/consul-client/issues/187)
- Can you provide example of how to subscribe to KV changes? [\#186](https://github.com/OrbitzWorldwide/consul-client/issues/186)

## [0.13.4](https://github.com/OrbitzWorldwide/consul-client/tree/0.13.4) (2016-11-23)
[Full Changelog](https://github.com/OrbitzWorldwide/consul-client/compare/0.13.3...0.13.4)

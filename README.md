...
Grab the latest binary (0.9.11) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/0.9.11/#consul-client-0.9.11.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:0.9.11'

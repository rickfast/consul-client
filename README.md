...
Grab the latest binary (0.10.1) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/0.10.1/#consul-client-0.10.1.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:0.10.1'

...
Grab the latest binary (0.9.8) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/0.9.8/#consul-client-0.9.8.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:0.9.8'

...
Grab the latest binary (1.2.4) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/1.1.2/#consul-client-1.0.1.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:1.2.4'
}
```

...
Grab the latest binary (0.12.8) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/0.12.0/#consul-client-0.12.0.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:0.12.8'
}
```

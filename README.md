...
Grab the latest binary (0.13.12) [here](http://dl.bintray.com/orbitz/consul-client/com/orbitz/consul/consul-client/0.13.11/#consul-client-0.13.11.jar).
...
dependencies {
    compile 'com.orbitz.consul:consul-client:0.13.12'
}
```
